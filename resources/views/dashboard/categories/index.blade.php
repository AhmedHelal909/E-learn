                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$row->rate}}</td>
                            <td>{{isset($row->parent->name) ? $row->parent->name :__('site.no_parent')}}</td>
                            @if($row->parent_id !=null)
                                <td><a href="{{route('dashboard.products.show',$row->id)}}">@lang('site.products')</a></td>
                            @else
                            ...
                            {{-- <td>77</td>
                            <td><a href="#" class="btn-info btn-sm">@lang('site.related_products')</a> </td> --}}
                            <td>
