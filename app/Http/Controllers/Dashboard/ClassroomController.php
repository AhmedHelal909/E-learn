...
class ClassroomController extends BackEndController
{
    /**
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            //     'ar.description'   => 'required|min:5|unique:category_translations,description',
                 'en.description'   => 'min:5|max:300|unique:category_translations,description|nullable',
    ...
    public function destroy($id, Request $request)
    {
        ...
        if($classroom->image != null){
            Storage::disk('public_uploads')->delete('/category_images/' . $classroom->image);
        }
        $classroom->delete();
